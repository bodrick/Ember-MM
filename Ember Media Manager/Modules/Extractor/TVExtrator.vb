...
Public Class TVExtrator
    Public Property CurrentTVEp As Model.TVEp
    Private _previousFrameValue As Integer
    Public Property ExtractedImage As Image
    Public Event FrameSave()
    ...
    Private Sub tbFrame_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tbFrame.KeyUp
        If tbFrame.Value <> _previousFrameValue Then
            GrabTheFrame()
        End If
    End Sub
    ...
    Private Sub btnFrameSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFrameSave.Click
        If Not IsNothing(pbFrame.Image) Then
            ExtractedImage = pbFrame.Image
            RaiseEvent FrameSave()
        End If
    End Sub
    ...
    Private Sub btnFrameLoad_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFrameLoad.Click
        Try
            Using ffmpeg As New Process()
                ...
                ffmpeg.StartInfo.Arguments = String.Format("-ss 0 -i ""{0}"" -an -f rawvideo -vframes 1 -s 1280x720 -vcodec mjpeg -y ""{1}""", CurrentTVEp.TVEpPath.FilePath, Path.Combine(Master.TempPath, "frame.jpg"))
    ...
    Private Sub GrabTheFrame()
        Try
            ...
            ffmpeg.StartInfo.Arguments = String.Format("-ss {0} -i ""{1}"" -vframes 1 -y ""{2}""", tbFrame.Value, CurrentTVEp.TVEpPath.FilePath, Path.Combine(Master.TempPath, "frame.jpg"))
            ffmpeg.EnableRaisingEvents = False
            ffmpeg.StartInfo.UseShellExecute = False
            ffmpeg.StartInfo.CreateNoWindow = True
            ...
            If File.Exists(Path.Combine(Master.TempPath, "frame.jpg")) Then
                ...
                _previousFrameValue = tbFrame.Value
            Else
