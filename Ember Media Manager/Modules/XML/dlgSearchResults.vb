...
#Region "Fields"
    ...
    Private lMediaTag As MediaTags.MovieTag ' XMLScraper.MediaTags.MediaTag
    Private sHTTP As New HTTP
    Private _currnode As Integer = -1
    Private _prevnode As Integer = -2
    Private mList As List(Of ScrapeResultsEntity)
...
#Region "Methods"
    ...
    Public Overloads Function ShowDialog(ByVal Res As List(Of ScrapeResultsEntity), ByVal sMovieTitle As String, ByVal scrapername As String, ByVal ScraperThumb As String, ByVal xmlmanager As ScraperManager) As MediaTags.MovieTag
        '//
    ...
    Private Sub bwSearchInfo_DoWork(ByVal sender As Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bwSearchInfo.DoWork
        mList = XMLManager.GetResults(_scrapername, e.Argument.ToString, String.Empty, ScrapeResultsType.Movie)
    End Sub
    ...
    Private Sub bwDownloadInfo_DoWork(ByVal sender As Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bwDownloadInfo.DoWork
        Try
            ...
            lMediaTag = DirectCast(XMLManager.GetDetails(mList(idx)), MediaTags.MovieTag)
