    ...
    Public Sub New()
        ...
        Try
            ...
            For Each s As Structures.MovieSource In Master.MovieSources
                Dim i As Integer = dgvSources.Rows.Add(New Object() {False, s.Name, EmberResources.film, String.Empty, "movie"})
            ...
            For Each s As Structures.TVSource In Master.TVSources
                Dim i As Integer = dgvSources.Rows.Add(New Object() {False, s.Name, EmberResources.television, String.Empty, "tv"})
                dgvSources.Rows(i).Cells(1).ToolTipText = s.Path
