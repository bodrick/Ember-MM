...
#Region "Methods"
        ...
        Public Overloads Sub Show(ByVal _type As String, ByVal _icon As Integer, ByVal _title As String, ByVal _message As String, ByVal _customicon As Image)
            ...
            Else
                Select Case _icon
                    Case 1
                        pbIcon.Image = My.Resources.Modules.large_icon_Error
                    Case 2
                        pbIcon.Image = My.Resources.Modules.large_icon_Comment
                    Case 3
                        pbIcon.Image = My.Resources.Modules.large_icon_Movies
                    Case 4
                        pbIcon.Image = My.Resources.Modules.large_icon_TV
                    Case Else
                        pbIcon.Image = My.Resources.Modules.large_icon_Info
                End Select
            End If
            ...
            Select Case AnimationType
                ...
                Case AnimationTypes.Show
                    ...
                    If Height < 80 Then
                        ...
                        For Each DisplayedForm As frmNotify In frmNotify.DisplayedForms.Where(Function(s) s.Index < Index)
                            DisplayedForm.Top -= 2
                        Next
                    Else
                        AnimationTimer.Stop()
                        ...
                        AnimationType = AnimationTypes.Wait
                ...
                Case AnimationTypes.Wait
                    ...
                    AnimationType = AnimationTypes.Close
                    AnimationTimer.Start()
        ...
        Private Sub frmNotify_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Click
            RaiseEvent NotifierClicked(_type)
        End Sub
        ...
        Private Sub frmNotify_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
            AnimationTimer.Stop()
            AnimationTimer.Interval = 5
            AnimationType = AnimationTypes.Show
            AnimationTimer.Start()
        End Sub
