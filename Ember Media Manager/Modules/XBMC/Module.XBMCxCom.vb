...
#Region "Methods"
    ...
    Public Sub Init(ByVal sAssemblyName As String)
    ...
    Private Sub bwRunUpdate_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bwRunUpdate.DoWork
        ...
        End Try
    End Sub
    Public Function RunGeneric(ByVal mType As Enums.ModuleEventType, ByRef _params As System.Collections.Generic.List(Of Object), ByRef _refparam As Object) As Interfaces.ModuleResult
        Select Case True
    ...
    Public Overrides Sub Setup()
        Try
            ...
            MyMenu.Image = New Bitmap(My.Resources.Modules.small_icon_XBMC)
            MyMenu.Text = Master.eLang.GetString(18, Languages.XBMC)
            'tsb = DirectCast(_parentForm.tsMain.Items("tsbMediaCenters"), ToolStripSplitButton)
            Dim tsi As New ToolStripMenuItem
            MyTrayMenu.Image = New Bitmap(My.Resources.Modules.small_icon_XBMC)
            MyTrayMenu.Text = Master.eLang.GetString(19, "XBMC Controller")
            tsi = DirectCast(_parentForm.cmnuTrayIcon.Items("cmnuTrayIconMediaCenters"), ToolStripMenuItem)
