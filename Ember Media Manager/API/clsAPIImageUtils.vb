...
#Region "Methods"
        ...
        Public Shared Function AddMissingStamp(ByVal oImage As Image) As Image
            ...
            Dim oWidth As Integer = If(nImage.Width >= My.Resources.Modules.img_Missing.Width, My.Resources.Modules.img_Missing.Width, nImage.Width)
            Dim oheight As Integer = If(nImage.Height >= My.Resources.Modules.img_Missing.Height, My.Resources.Modules.img_Missing.Height, nImage.Height)
            grOverlay.InterpolationMode = InterpolationMode.HighQualityBicubic
            grOverlay.DrawImage(My.Resources.Modules.img_Missing, 0, 0, oWidth, oheight)
        ...
        Public Shared Sub SetGlassOverlay(ByRef pbUnderlay As PictureBox)
            ...
            Try
                ...
                grOverlay.DrawImage(My.Resources.Modules.img_Overlay, 0, 0, pbUnderlay.Image.Width, bmHeight)
                pbUnderlay.Image = bmOverlay

                bmOverlay = New Bitmap(pbUnderlay.Image)
                grOverlay = Graphics.FromImage(bmOverlay)

                grOverlay.DrawImage(My.Resources.Modules.img_Overlay2, 0, 0, pbUnderlay.Image.Width, pbUnderlay.Image.Height)
                pbUnderlay.Image = bmOverlay
