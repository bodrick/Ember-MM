...
#Region "Methods"
        ...
        Public Function MoviePostScrapeOnly(ByRef DBMovie As Model.Movie, ByVal ScrapeType As Enums.ScrapeType) As Interfaces.ModuleResult
            Dim ret As Interfaces.ModuleResult
        ...
        Public Function MovieScrapeOnly(ByRef DBMovie As Model.Movie, ByVal ScrapeType As Enums.ScrapeType, ByVal Options As Structures.ScrapeOptions) As Boolean
            Dim ret As Interfaces.ModuleResult
        ...
        Function GetMovieStudio(ByRef DBMovie As Model.Movie) As List(Of String)
            Dim ret As Interfaces.ModuleResult
            Dim sStudio As New List(Of String)
        ...
        Function ScraperDownloadTrailer(ByRef DBMovie As Model.Movie) As String
            Dim ret As Interfaces.ModuleResult
        ...
        Function ScraperSelectImageOfType(ByRef DBMovie As Model.Movie, ByVal _DLType As Enums.ImageType, ByRef pResults As Containers.ImgResult, Optional ByVal _isEdit As Boolean = False, Optional ByVal preload As Boolean = False) As Boolean
            Dim ret As Interfaces.ModuleResult
            For Each _externalScraperModule As _externalScraperModuleClass In externalScrapersModules.Where(Function(e) e.ProcessorModule.IsPostScraper AndAlso e.ProcessorModule.PostScraperEnabled).OrderBy(Function(e) e.PostScraperOrder)
                Try
