...
#End Region 'Methods
        ...
        Public Class SettingsPanel
            ...
            <System.Xml.Serialization.XmlIgnore()> _
            Public Property Panel() As EmberControls.ManagedPanel
...
#Region "Methods"
            ...
            If Directory.Exists(ShowPath) Then
                ...
                For Each sDir As DirectoryInfo In dInfo.GetDirectories
                    For Each rShow As Settings.TVShowRegEx In Master.eSettings.TVShowRegexes.Where(Function(s) s.SeasonFromDirectory = True)
                        For Each sMatch As Match In Regex.Matches(FileUtils.GetDirectory(sDir.FullName), rShow.SeasonRegex, RegexOptions.IgnoreCase)
                            Try
        ...
        Public Shared Function IsSeasonDirectory(ByVal sPath As String) As Boolean
            For Each rShow As Settings.TVShowRegEx In Master.eSettings.TVShowRegexes.Where(Function(s) s.SeasonFromDirectory = True)
                If Regex.IsMatch(FileUtils.GetDirectory(sPath), rShow.SeasonRegex, RegexOptions.IgnoreCase) Then Return True
            Next
            'no matches
            Return False
        End Function
...
#End Region 'Fields
        ...
        Public Class DBTV
#Region "Fields"
            Public Property EpFanartPath As String
            Public Property EpID As Long
            Public Property EpNeedsSave As Boolean
            Public Property EpNfoPath As String
            Public Property EpPosterPath As String
            Public Property Filename As String
            Public Property IsLockEp As Boolean
            Public Property IsLockSeason As Boolean
            Public Property IsLockShow As Boolean
            Public Property IsMarkEp As Boolean
            Public Property IsMarkSeason As Boolean
            Public Property IsMarkShow As Boolean
            Public Property SeasonFanartPath As String
            Public Property SeasonPosterPath As String
            Public Property ShowFanartPath As String
            Public Property ShowID As Long
            Public Property ShowLanguage As String
            Public Property ShowNeedsSave As Boolean
            Public Property ShowNfoPath As String
            Public Property ShowPath As String
            Public Property ShowPosterPath As String
            Public Property Source As String
            Public Property TVEp As MediaContainers.EpisodeDetails
