...
#Region "Methods"
        ...
        Public Shared Function GetAVImages(ByVal fiAV As MediaInfo.Fileinfo, ByVal fName As String, ByVal ForTV As Boolean, ByVal fileSource As String) As Image()
            ...
            Dim tAudio As MediaInfo.Audio = MediaInfo.GetBestAudio(fiAV, ForTV)

            If lFlags.Count > 0 Then
                Try
                    Dim vRes As String = MediaInfo.GetResFromDimensions(tVideo).ToLower
                    ...
                    Else
                        ...
                        If Not IsNothing(vresFlag) Then
                            iReturn(0) = vresFlag.Image
                        Else
                            iReturn(0) = My.Resources.Modules.img_Default_Screen
                        End If
                    End If

                    Dim vSource As String = fileSource 'GetFileSource(fName)
                    Dim vsourceFlag As Flag = Nothing
                    If Not String.IsNullOrEmpty(vSource) Then
                        vsourceFlag = lFlags.FirstOrDefault(Function(f) f.Name.ToLower = vSource.ToLower AndAlso f.Type = FlagType.VideoSource)
                    End If
                    ...
                    Else
                        ...
                        If Not IsNothing(vsourceFlag) Then
                            iReturn(1) = vsourceFlag.Image
                        Else
                            iReturn(1) = My.Resources.Modules.img_Default_Screen
                        End If
                    End If
                    ...
                    Else
                        ...
                        If Not IsNothing(vcodecFlag) Then
                            iReturn(2) = vcodecFlag.Image
                        Else
                            iReturn(2) = My.Resources.Modules.img_Default_Screen
                        End If
                    End If
                    ...
                    If Not IsNothing(acodecFlag) Then
                        If tAudio.HasPreferred Then
                            iReturn(3) = ImageUtils.SetOverlay(acodecFlag.Image, 64, 44, My.Resources.Modules.small_icon_Notify, 4)
                        Else
                    ...
                    Else
                        ...
                        Else
                            If tAudio.HasPreferred Then
                                iReturn(3) = ImageUtils.SetOverlay(My.Resources.Modules.img_Default_Sound, 64, 44, My.Resources.Modules.small_icon_Notify, 4)
                            Else
                                iReturn(3) = My.Resources.Modules.img_Default_Sound
                            End If
                        End If
                    End If
                    ...
                    Else
                        ...
                        If Not IsNothing(achanFlag) Then
                            iReturn(4) = achanFlag.Image
                        Else
                            iReturn(4) = My.Resources.Modules.img_Default_Sound
                        End If
                    End If
            ...
            Else
                ...
                iReturn(2) = My.Resources.Modules.img_Default_Screen
                If tAudio.HasPreferred Then
                    iReturn(3) = ImageUtils.SetOverlay(My.Resources.Modules.img_Default_Sound, 64, 44, My.Resources.Modules.img_Actor_Silhouette, 4)
                Else
                    iReturn(3) = My.Resources.Modules.img_Default_Sound
                End If
                iReturn(4) = My.Resources.Modules.img_Default_Sound
            ...
            If GenreXML.Nodes.Count > 0 Then
                ...
                Try
                    ...
                    If Not String.IsNullOrEmpty(imgGenreStr) AndAlso alGenres.Contains(imgGenreStr.ToLower) Then
                        ...
                        End Using
                    Else
                        imgGenre = My.Resources.Modules.img_Default_Genre
                    End If
        ...
        Public Shared Function GetStudioImage(ByVal strStudio As String) As Image
            ...
            If IsNothing(imgStudio) Then imgStudio = My.Resources.Modules.img_Default_Screen
