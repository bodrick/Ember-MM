...
#Region "Methods"
            ...
            Function DownloadTrailer(ByRef DBMovie As Model.Movie, ByRef sURL As String) As ModuleResult

            Function GetMovieStudio(ByRef DBMovie As Model.Movie, ByRef sStudio As List(Of String)) As ModuleResult
            ...
            Function PostScraper(ByRef DBMovie As Model.Movie, ByVal ScrapeType As Enums.ScrapeType) As ModuleResult
            ...
            Function Scraper(ByRef DBMovie As Model.Movie, ByRef ScrapeType As Enums.ScrapeType, ByRef Options As Structures.ScrapeOptions) As ModuleResult

            Function SelectImageOfType(ByRef DBMovie As Model.Movie, ByVal _DLType As Enums.ImageType, ByRef pResults As Containers.ImgResult, Optional ByVal _isEdit As Boolean = False, Optional ByVal preload As Boolean = False) As ModuleResult
