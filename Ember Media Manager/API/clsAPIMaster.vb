...
#Region "Fields"
        ...
        Public Shared currMovie As New Model.Movie
        Public Shared currShow As New Model.TVEp        
        ...
        Public Shared tmpMovie As New Model.Movie
        Public Shared MovieSources As New List(Of Model.Source)
        Public Shared TVSources As New List(Of Model.TVSource)
        Public Shared MajorVersion As Single = 1.3
        Public Shared CurrentMediaItem As Object
        Public Shared ScraperMan As ScraperManager
#End Region 'Fields
