...
#Region "Methods"
    ...
    Private Sub dlgEditSeason_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Master.eSettings.SeasonFanartEnabled OrElse (String.IsNullOrEmpty(Functions.GetSeasonDirectoryFromShowPath(Master.currShow.ShowPath, Master.currShow.TVEp.Season)) AndAlso Not Master.eSettings.SeasonXXDashFanartJPG) Then TabControl1.TabPages.Remove(TabPage3)
    ...
    Private Sub FillInfo()
        With Me
            ...
            If Master.eSettings.SeasonXXDashFanartJPG OrElse (Master.eSettings.SeasonFanartEnabled AndAlso Not String.IsNullOrEmpty(Functions.GetSeasonDirectoryFromShowPath(Master.currShow.ShowPath, Master.currShow.TVEp.Season))) Then
