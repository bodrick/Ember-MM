...
#Region "Fields"
    ...
    Public Shared tmpTVShow As Model.TVShow
...
#Region "Methods"
    ...
    Public Function GetLangs(ByVal sMirror As String) As List(Of Containers.TVLanguage)
        ...
        Dim apiXML As String = Classes.Http.DownloadData(String.Format("http://{0}/api/{1}/languages.xml", sMirror, APIKey))
        ...
        If Not String.IsNullOrEmpty(apiXML) Then
            ...
            Catch
                Return tvdbLangs
            End Try
            tvdbLangs = From xLanguages In xmlTVDB.Descendants("Language") Select New Containers.TVLanguage With {.LongLang = xLanguages.Element("name").Value, .ShortLang = xLanguages.Element("abbreviation").Value}          
        End If
        Return tvdbLangs
    End Function
