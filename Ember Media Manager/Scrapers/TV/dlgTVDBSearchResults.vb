...
#Region "Methods"
    ...
    Public Overloads Function ShowDialog(showTitle As String) As Windows.Forms.DialogResult
        _showTitle = showTitle
        Me.Text = String.Concat(Master.eLang.GetString(85, "TV Search Results"), " - ", showTitle)
        Scraper.sObject.GetSearchResultsAsync(Me.sInfo)

        Return MyBase.ShowDialog()
    End Function

    Public Overloads Function ShowDialog(showTitle As String, ByVal SkipDownload As Boolean) As Structures.ScrapeInfo
        _showTitle = showTitle
        Me._skipdownload = SkipDownload

        Me.Text = String.Concat(Master.eLang.GetString(85, "TV Search Results"), " - ", _showTitle)
        Scraper.sObject.GetSearchResultsAsync(Me.sInfo)
    ...
    Private Sub btnVerify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVerify.Click
        If IsNumeric(Me.txtTVDBID.Text) AndAlso Me.txtTVDBID.Text.Length >= 5 Then
            ...
            Dim forceXML As String = Classes.Http.DownloadData(String.Format("http://{0}/api/{1}/series/{2}/{3}.xml", Master.eSettings.TVDBMirror, Scraper.APIKey, Me.txtTVDBID.Text, Master.eSettings.TVDBLanguage))
                    ...
                    If Not IsNothing(tSer) Then
                        ...
                        If Not String.IsNullOrEmpty(Me._manualresult.Name) AndAlso Not String.IsNullOrEmpty(sLang) Then
                            If Not String.IsNullOrEmpty(Me._manualresult.Banner) Then
                                ...
                                Me.bwDownloadPic.RunWorkerAsync(New With {.pURL = Me._manualresult.Banner})
                            End If
    ...
    Private Sub bwDownloadPic_DoWork(ByVal sender As Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bwDownloadPic.DoWork        
        Dim tempImage As Image = Classes.Http.DownloadImage(String.Format("http://{0}/banners/_cache/{1}", Master.eSettings.TVDBMirror, e.Argument.pURL))
        e.Result = New With {.Image = tempImage}
    End Sub

    Private Sub bwDownloadPic_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles bwDownloadPic.RunWorkerCompleted        
        Try
            pbBanner.Image = e.Result.Image
    ...
    Private Sub lvSearchResults_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lvSearchResults.SelectedIndexChanged
        ...
        If Me.lvSearchResults.SelectedItems.Count > 0 AndAlso Not Me.chkManual.Checked Then
            ...
            If Not String.IsNullOrEmpty(SelectedShow.Banner) Then
                ...
                Me.bwDownloadPic = New System.ComponentModel.BackgroundWorker
                Me.bwDownloadPic.WorkerSupportsCancellation = True
                Me.bwDownloadPic.RunWorkerAsync(New With {.pURL = SelectedShow.Banner})
            End If
