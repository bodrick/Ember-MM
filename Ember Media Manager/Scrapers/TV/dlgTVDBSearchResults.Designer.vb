...
Partial Class dlgTVDBSearchResults
    ...
    Private Sub InitializeComponent()
        ...
        Me.lvSearchResults = New BrightIdeasSoftware.ObjectListView()
        Me.colName = CType(New BrightIdeasSoftware.OLVColumn(), BrightIdeasSoftware.OLVColumn)
        Me.colLang = CType(New BrightIdeasSoftware.OLVColumn(), BrightIdeasSoftware.OLVColumn)
        Me.colLev = CType(New BrightIdeasSoftware.OLVColumn(), BrightIdeasSoftware.OLVColumn)
        Me.colID = CType(New BrightIdeasSoftware.OLVColumn(), BrightIdeasSoftware.OLVColumn)
        Me.colSLang = CType(New BrightIdeasSoftware.OLVColumn(), BrightIdeasSoftware.OLVColumn)
        ...
        CType(Me.lvSearchResults, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.PictureBox1.Image = Global.EmberMediaManger.My.Resources.Modules.large_icon_Search
        ...
        CType(Me.lvSearchResults, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents lvSearchResults As ObjectListView
    Friend WithEvents colName As OLVColumn
    Friend WithEvents colLang As OLVColumn
    ...
    Friend WithEvents colLev As OLVColumn
    Friend WithEvents colID As OLVColumn
    Friend WithEvents colSLang As OLVColumn
