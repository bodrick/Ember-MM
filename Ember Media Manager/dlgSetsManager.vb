...
Public Class dlgSetsManager
    ...
    '                            tmpMovie = Classes.Database.GetMovie(Convert.ToInt64(SQLreader("ID")))
    '                            If Not String.IsNullOrEmpty(tmpMovie.Title) Then
    '                                lMovies.Add(New Movies With {.DBMovie = tmpMovie, .ListTitle = String.Concat(StringUtils.FilterTokens(tmpMovie.Title), If(Not String.IsNullOrEmpty(tmpMovie.Year), String.Format(" ({0})", tmpMovie.Year), String.Empty))})
    '                                For Each mSet As Model.MoviesSet In tmpMovie.MoviesSets
    '                                    If Not alSets.Contains(mSet.SetName) AndAlso Not String.IsNullOrEmpty(mSet.SetName) Then
    '                                        alSets.Add(mSet.SetName)
    '                                    End If
    '                                Next
    '                            End If
    ...
    '        Try
    '            lMov.DbMovie.MoviesSets.Remove(currSet)
    ...
    '        Public Property DbMovie As Model.Movie
