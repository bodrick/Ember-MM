...
''' </summary>
''' <remarks></remarks>
Public Class RogueScraperModule
...
#Region "Fields"
    ...
    Private _Name As String = "Rogue's Movie Scraper"
...
#Region "Methods"
    ...
    Function InjectSetupPostScraper() As Containers.SettingsPanel Implements Interfaces.EmberMovieScraperModule.InjectSetupPostScraper
        ...
        If MySettings.ExtraThumbsFolderName = "extrafanart" Then
            _setupPost.optFanartFolderExtraThumbs.Checked = False
            _setupPost.optFanartFolderExtraFanart.Checked = True
        Else
            _setupPost.optFanartFolderExtraThumbs.Checked = True
            _setupPost.optFanartFolderExtraFanart.Checked = False
        End If

        _setupPost.orderChanged()
        Spanel.Name = String.Concat(Me._Name, "PostScraper")
        Spanel.Text = "Rogue's Ember Movie Scraper"
        Spanel.Prefix = "MovieMedia_"
        Spanel.Order = 110
    ...
    Function InjectSetupScraper() As Containers.SettingsPanel Implements Interfaces.EmberMovieScraperModule.InjectSetupScraper
        ...
        SPanel.Text = "Rogue's Movie Scraper"
        SPanel.Prefix = "MovieInfo_"
        SPanel.Order = 110
    ...
    Sub LoadSettings()
        ...
        MySettings.ExtraThumbsFolderName = AdvancedSettings.GetSetting("ExtraThumbsFolderName", "extrathumbs")
    ...
    Sub SaveSettings()
        ...
        AdvancedSettings.SetSetting("ExtraThumbsFolderName", MySettings.ExtraThumbsFolderName)
    ...
    Sub SaveSetupPostScraper(ByVal DoDispose As Boolean) Implements Interfaces.EmberMovieScraperModule.SaveSetupPostScraper
        ...
        If _setupPost.optFanartFolderExtraFanart.Checked Then
            MySettings.ExtraThumbsFolderName = "extrafanart"
        Else
            MySettings.ExtraThumbsFolderName = "extrathumbs"
        End If
...
#Region "Fields"
        ...
        Dim ExtraThumbsFolderName As String
