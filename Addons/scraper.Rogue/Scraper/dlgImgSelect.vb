...
Public Class dlgImgSelect
                ...
                If Me.DLType = Enums.ImageType.Fanart OrElse (Master.eSettings.UseImgCache OrElse Me.TMDBPosters.Item(i).Description = "cover") Then
                    ...
                    Try
                        ...
                        If Master.eSettings.UseImgCache OrElse Master.eSettings.AutoET Then
                            Try
                                'had to change this because we need to look for additional text in url to identify it as TMDB
    ...
    Private Sub DoSelect(ByVal iIndex As Integer, ByVal sURL As String)
        Try
            ...
            If Not Me.DLType = Enums.ImageType.Fanart AndAlso IsTMDBURL(sURL) Then
                Me.SetupSizes(sURL)
    ...
    Private Function IsTMDBURL(ByVal sURL As String) As Boolean
        If sURL.ToLower.Contains("themoviedb.org") OrElse sURL.ToLower.Contains("cf1.imgobject.com") Then
            Return True
        Else
            Return False
        End If
