...
#End Region 'Fields
    ...
    Public Overloads Function ShowDialog(ByVal sMovieTitle As String, ByVal filterOptions As Structures.ScrapeOptions) As Windows.Forms.DialogResult
        ...
        Me.Text = String.Concat("Rogue's ", Master.eLang.GetString(10, "Search Results - "), sMovieTitle)
    ...
    Private Sub SetUp()
        ...
        Me.Label1.Text = String.Concat("Rogue's ", Master.eLang.GetString(22, "Movie Search Results"))
        ...
        Me.lblIMDBHeader.Text = Master.eLang.GetString(61, "IMDB ID:", True)
