...
#Region "Methods"
    ...
    Sub SaveSettings()
        AdvancedSettings.SetSetting("ExportPath", MySettings.ExportPath)
        AdvancedSettings.SetBooleanSetting("ExportTVShows", MySettings.ExportTVShows)
        AdvancedSettings.SetSetting("ExportPosterHeight", CStr(MySettings.ExportPosterHeight))
        AdvancedSettings.SetSetting("ExportFanartWidth", CStr(MySettings.ExportFanartWidth))
        AdvancedSettings.SetSetting("ExportFilter1", MySettings.ExportFilter1)
        AdvancedSettings.SetSetting("ExportFilter2", MySettings.ExportFilter2)
        AdvancedSettings.SetSetting("ExportFilter3", MySettings.ExportFilter3)
        AdvancedSettings.SetSetting("ExportImageQuality", CStr(MySettings.ExportImageQuality))
    End Sub
