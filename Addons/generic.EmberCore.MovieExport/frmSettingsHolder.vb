...
#Region "Methods"
    ...
    Private Sub SetUp()
        ...
        Me.chkExportTVShows.Text = Master.eLang.GetString(16, "Export TV Shows")
        Me.lbl_exportmoviefiltergenerate.Text = Master.eLang.GetString(17, "Generate Filter")
        Me.txt_exportmoviepath.Text = Master.eLang.GetString(18, "Export Path")
        Me.lbl_exportmoviefanart.Text = Master.eLang.GetString(19, "Fanart Width [px]")
        Me.lbl_exportmovieposter.Text = Master.eLang.GetString(20, "Poster Height [px]")
        Me.lbl_exportmoviequality.Text = Master.eLang.GetString(478, "Quality:")
        Me.gpb_ExportFilterSettings.Text = Master.eLang.GetString(21, "Filter Settings")
        Me.gpb_ExportImage.Text = Master.eLang.GetString(22, "Image Settings")
        Me.gpb_ExportGeneralSettings.Text = Master.eLang.GetString(23, "General Settings")
        Me.btn_Apply.Text = Master.eLang.GetString(24, "Save Filter")
        Me.btn_Reset.Text = Master.eLang.GetString(25, "Reset Filter")
        Me.lblIn.Text = Master.eLang.GetString(11, "in")
        Me.cbSearch.Items.AddRange(New Object() {Master.eLang.GetString(1, "Source Folder"), Master.eLang.GetString(21, "Title", True), Master.eLang.GetString(278, "Year", True), Master.eLang.GetString(2, "Video Flag"), Master.eLang.GetString(3, "Audio Flag")})
