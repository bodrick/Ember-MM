...
Public Class frmXMLSettingsHolder
    ...
    Sub SetUp()
		...
		Me.chkFullCast.Text = Master.eLang.GetString(512, "Scrape Full Cast", False)
		Me.chkFullCrew.Text = Master.eLang.GetString(513, "Scrape Full Crew", False)
		...
		Me.lblLanguage.Text = Master.eLang.GetString(610, "Language")
